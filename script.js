    ...
    pizzaItem.querySelector('a').addEventListener('click', (e)=>{
        ...
        cs('.pizzaInfo--size').forEach((size, sizeIndex)=>{
            ...
            size.addEventListener('click', ()=>{
                ...
                c('.pizzaInfo--actualPrice').innerHTML = `${pizzaJson[key].price[sizeIndex].toLocaleString('pt-br',{style: 'currency', currency:'BRL'})}`;
            });
        });
...
c('.pizzaInfo--qtmenos').addEventListener('click', ()=>{
    if(modalQt > 1){
        ...
        let priceModal = pizzaJson[modalKey].price[size];
        modalQt--;
        c('.pizzaInfo--qt').innerHTML = modalQt;
        let updatePrice = priceModal * modalQt;
        c('.pizzaInfo--actualPrice').innerHTML = `${updatePrice.toLocaleString('pt-br', {style: 'currency', currency:'BRL'})}`;
    }
});
